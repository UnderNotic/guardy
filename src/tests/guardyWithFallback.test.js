...
describe("Guardy with fallback", () => {
  ...
  test("should return correct  __value__ for object", () => {
    ...
    expect(guardyWithFallback(testObj).obj1.obj2.__value__).toEqual(
      testObj.obj1.obj2
    );
  });

  test("should return correct  __value__ for custom object", () => {
    expect(guardyWithFallback(testObj).customObj.s3.__value__).toEqual(
      testObj.customObj.s3
    );
    expect(guardyWithFallback(testObj).customObj.func3.__value__).toEqual(
  ...
  test("should return correct  __value__ for function", () => {
    ...
    expect(guardyWithFallback(testObj).func1.__value__()).toEqual(
      testObj.func1()
    );
    expect(guardyWithFallback(testObj).obj1.obj2.func2.__value__).toEqual(
  ...
  test("should return correct  __value__ for lambda function", () => {
    expect(guardyWithFallback(testObj).l1.__value__).toEqual(testObj.l1);
    expect(guardyWithFallback(testObj).l1.__value__()).toEqual(testObj.l1());
  });
  ...
  test("should fallback to null (default)", () => {
    expect(Object.keys(guardyWithFallback(testObj).a.b.c)).toEqual([
      "__value__"
    ]);
    expect(guardyWithFallback(testObj).a.b.c.__value__).toBe(null);
    expect(Object.keys(guardyWithFallback(testObj).obj1.a.b.c)).toEqual([
      "__value__"
    ]);
    expect(guardyWithFallback(testObj).obj1.a.b.c.__value__).toBe(null);
    expect(Object.keys(guardyWithFallback(testObj).obj1.obj2.a.b.c.d)).toEqual([
      "__value__"
    ]);
  ...
  test("should fallback to null (default) when trying to access property of primitive", () => {
    ...
    expect(guardyWithFallback(testObj).obj1.obj2.n2.a.b.c.d.__value__).toBe(
      null
    );
  });
  ...
  test("should fallback to defaulty", () => {
    ...
    expect(guardyWithFallback(testObj, 0).obj1.obj2.n2.a.b.c.d.__value__).toBe(
      0
    );
  ...
  test("should work only with objects", () => {
    expect(() => guardyWithFallback("")).toThrow(
      "Guardy works only with objects!"
    );
    expect(() => guardyWithFallback(1)).toThrow(
      "Guardy works only with objects!"
    );
    expect(() => guardyWithFallback([])).toThrow(
      "Guardy works only with objects!"
    ...
    expect(() => guardyWithFallback(function() {})).toThrow(
      "Guardy works only with objects!"
    );
  });
});
